...
function App() {
  ...
  const testimonials = [
    {
      ...
      text: "Working with Andrei was an absolute pleasure. His attention to detail and commitment to quality exceeded my expectations.",
      rating: 4,
    },
    {
      image: "./karina.jpg",
      ...
      text: "Professional, creative, and reliable. I highly recommend Andrei for any web development or UI/UX design needs.",
      rating: 5,
    },
    {
      image: "./karina.jpg",
      ...
      text: "Andrei brought our project to life with amazing design work and clean code. Would love to collaborate again!",
      rating: 5,
    },
    {
      image: "./karina.jpg",
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-72 h-72 bg-gray-300/40 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 z-0"></div>
